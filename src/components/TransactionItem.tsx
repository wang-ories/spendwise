...
const styles = StyleSheet.create({
  transCard: { padding: 15, borderRadius: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  ...
  emptyContainer: { padding: 30, alignItems: 'center', backgroundColor: themes.surface, borderRadius: 20 }
});
